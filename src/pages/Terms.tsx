                ...
                <div>
                  ...
                  {section.id === "privacy" && (
                    <p className="text-Grey-60 leading-relaxed">
                      ...
                      <Link
                        to="/privacy"
                        className="text-Purple-60 hover:text-Purple-75 underline transition-colors"
                      >
                        Privacy Policy
                      </Link>
          ...
          <section className="group">
            <div className="bg-Grey-15 rounded-lg p-6 space-y-2 relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-Grey-60">Email: {contactInfo.email}</p>
                <p className="text-Grey-60">Phone: {contactInfo.phone}</p>
                <p className="text-Grey-60">Address: {contactInfo.address}</p>
              </div>
            </div>
          </section>
