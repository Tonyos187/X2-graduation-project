...
const Features = ({ data }: { data: FeaturesType[] }) => {
  return (
    <section className="grid grid-cols-2 md:grid-cols-4 gap-2.5 2xl:gap-5 p-2.5 2xl:p-5 shadow-[0_0_0_4px_#dbcefd] dark:shadow-[0_0_0_4px_#191919] border border-Grey-15 overflow-hidden lg:mt-1">
      {data.map((item, index) => {
