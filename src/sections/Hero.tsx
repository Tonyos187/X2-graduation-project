    ...
    <section className="w-full relative min-h-screen">
      ...
      <div className="mx-auto flex flex-col-reverse md:flex-row items-stretch justify-between gap-10 min-h-screen">
        ...
        <div className="w-full md:w-[48%] flex flex-col justify-center px-4 md:pl-12">
          <h1 className="text-[24px] md:text-[46px] xl:text-[60px] text-white mb-6 font-semibold leading-[120%] tracking-[0]">
            {headline}
          </h1>
        ...
        {/* Right Image */}
        <div
          className="w-full md:w-[48%] relative min-h-[400px] overflow-hidden"
