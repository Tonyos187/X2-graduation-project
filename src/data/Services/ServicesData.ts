import type { ServicesData } from "../../types/Services/ServicesTypes";

export const servicesData: ServicesData = {
  heroSection: {
    mainTitle: "Elevate Your Real Estate Experience",
  ...
  unlockProperty:{
    ...
    sectionDescription: "Expert solutions for all your real estate needs",
    cards: [
      {
        id: 1,
  ...
  effortlessProperty:{
    ...
    sectionDescription: "Owning a property should be a pleasure, not a hassle. Estatein's Property Management Service takes the stress out of property ownership, offering comprehensive solutions tailored to your needs. Explore the categories below to see how we can make property management effortless for you",
    cards: [
      {
        id: 1,
  ...
  smartInvestments:{
    ...
    sectionDescription: "Building a real estate portfolio requires a strategic approach. Estatein's Investment Advisory Service empowers you to make smart investments and informed decisions.",
    cards: [
      {
        id: 1,
        icon: "/assets/icons/signalIcon.svg",
