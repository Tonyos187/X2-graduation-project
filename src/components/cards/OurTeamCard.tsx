     ...
     <div className="relative">
      ...
      <div className="flex flex-col gap-4 lg:gap-5 xl:gap-6 flex-1">
        ...
        <div className="relative mt-auto">
          ...
          <label htmlFor={item.id} className="py-2 pr-2 pl-6 md:py-2.5 md:pr-2.5 md:pl-5 xl:py-3.5 xl:pr-3.5 xl:pl-6 text-sm/[28px] md:text-base/[28px] xl:text-lg/[28px] absolute left-2 md:left-2.5 xl:left-3.5 top-1/2 -translate-y-1/2 transition-all duration-200 peer-placeholder-shown:left-2 md:peer-placeholder-shown:left-2.5 xl:peer-placeholder-shown:left-3.5 peer-placeholder-shown:top-1/2 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:text-sm/[28px] md:peer-placeholder-shown:text-base/[28px] xl:peer-placeholder-shown:text-lg/[28px] peer-focus:top-0 peer-focus:left-4 md:peer-focus:left-4.5 xl:peer-focus:left-6 peer-focus:text-sm lg:peer-focus:text-base xl:peer-focus:text-lg peer-focus:text-Purple-75">{float ? "Message :" : "Say Hello 👋"}</label>
