...
const SearchFild: React.FC<Props> = ({ data }) => {
  ...
  const renderButton = (btn: CTAButton) => (
    <button
      className="flex items-center text-sm lg:text-lg font-medium justify-center gap-2 w-fit lg:w-46 h-[63px] px-[24px] py-[18px] rounded-[10px] bg-mainPurple text-white hover:bg-secPurple transition"
    >
      {btn.icon && (
  ...
  <div className=" px-4 sm:px-6 md:px-20 lg::px-[148px] mx-auto py-4 w-full max-w-[1596px] h-[103px]">
    <div className="relative w-full h-[103px]">
      <input
        ...
        className="w-full h-full text-base md:text-xl  px-[24px] py-[20px] rounded-tl-[12px] rounded-tr-[12px] rounded-bl-[12px] rounded-br-[12px] md:rounded-tl-[12px] md:rounded-tr-[12px] md:rounded-bl-[0px] md:rounded-br-[0px] border border-[#262626] shadow-[0px_0px_0px_10px_#191919] bg-[#0E0E0E] text-white placeholder:text-gray-400 focus:outline-none "
      />
