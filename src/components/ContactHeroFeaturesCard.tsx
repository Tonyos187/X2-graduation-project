...
const ContactHeroFeaturesCard = ({
  ...
  return (
    <div className="relative group flex flex-col items-center justify-center gap-3.5 lg:gap-4 2xl:gap-5 py-[5.1282vw] px-[3.5897vw] lg:py-[2.0834vw] lg:px-[1.1112vw] 2xl:py-[2.08334vw] 2xl:px-[1.04167vw] border border-[#262626] rounded-[10px] bg-darkGray z-40 hover:scale-105 cursor-pointer">
      <div className="absolute top-5 right-5 w-6.5 h-6.5 2xl:w-8.5 2xl:h-8.5 text-[#4D4D4D]">
        {item.arrow}
      </div>
