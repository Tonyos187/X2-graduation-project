...
const Statistics = () => {
  ...
  const cardClassNames = [
    "bg-darkGray tablet:w-[31.4%] laptop:w-[32.4%] w-[48.324%]",     // Card 1
    "bg-darkGray tablet:w-[31.4%] laptop:w-[32.4%] w-[48.324%]",     // Card 2
    "bg-darkGray tablet:w-[31.4%] laptop:w-[32.4%] w-full",     // Card 3
  ];
