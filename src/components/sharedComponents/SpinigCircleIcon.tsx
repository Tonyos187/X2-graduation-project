...
function SpinigCircleIcon({iconURL}:{iconURL:string}) {
  ...
  return (
     <div className="relative mt-8 xs:mt-0 w-12 h-12 lg:w-15 lg:h-15 2xl:w-20.5 2xl:h-20.5 z-10">
        <div className="relative rounded-full bg-Grey-10 w-12 h-12 lg:w-15 lg:h-15 2xl:w-20.5 2xl:h-20.5 flex justify-center items-center
          ...
          <div className="relative rounded-full bg-Grey-10 w-9 h-9 lg:w-11 lg:h-11 2xl:w-15.5 2xl:h-15.5 
          ...
          >
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-9 h-9 lg:w-11 lg:h-11 2xl:w-15.5 2xl:h-15.5 bg-Grey-10 rounded-full z-30 flex justify-center items-center">
              <img
                src={iconURL}
                alt="icon"
