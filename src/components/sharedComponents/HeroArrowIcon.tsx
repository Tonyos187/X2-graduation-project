      ...
      >
        <div className="absolute w-full h-full rounded-full animate-rotate">
          {text.split("").map((char, i) => (
            <span
              key={i}
              className="absolute left-1/2 text-[10.03px] tablet:text-[11.06px] laptop:text-[15px] font-semibold 
              z-10 p-1.5 tablet:py-2 laptop:py-3 text-animate"
              style={{
        ...
        <div className="text-white flex items-center justify-center bg-borderColor w-[45%] h-[45%] rounded-full border border-borderColor 
